...
namespace AxiomModel {
    ...
    Sequence<ItemType> blank() {
        using ReturnFunc = std::function<std::optional<ItemType>()>;
        return Sequence(std::function<ReturnFunc()>([]() -> ReturnFunc {
    ...
    Sequence<ItemType> oneShot(ItemType item) {
        using ReturnFunc = std::function<std::optional<ItemType>()>;
        return Sequence(std::function<ReturnFunc()>([item]() -> ReturnFunc{
    ...
    Sequence<typename Collection::value_type> wrap(const Collection &collection) {
        using ReturnFunc = std::function<std::optional<typename Collection::value_type>()>;
        return Sequence(
            std::function<ReturnFunc()>([&collection]() -> ReturnFunc {
    ...
    Sequence<typename Collection::value_type::value_type> flatten(Collection collection) {
        using ReturnFunc = std::function<std::optional<typename Collection::value_type::value_type>()>;
        return Sequence(
            std::function<ReturnFunc()>([collection]()
                              -> ReturnFunc {
    ...
    SequenceMapFilter<OutputItem, typename InputCollection::value_type>
        ...
        return mapFilter(std::move(collection), std::function<std::optional<OutputItem>(const typename InputCollection::value_type &)>([next](const typename InputCollection::value_type &base)
    ...
    SequenceMapFilter<typename Collection::value_type, typename Collection::value_type>
        ...
        return mapFilter(std::move(collection), std::function<std::optional<typename Collection::value_type>(const typename Collection::value_type &)>([next](const typename Collection::value_type &base)
    ...
    SequenceMapFilter<OutputItem, typename InputCollection::value_type> dynamicCast(InputCollection collection) {
        return mapFilter(
            std::move(collection),
            std::function<std::optional<OutputItem>(const typename InputCollection::value_type &b)>([](const typename InputCollection::value_type &base) -> std::optional<OutputItem> {
    ...
    SequenceMapFilter<OutputItem, typename InputCollection::value_type> staticCast(InputCollection collection) {
        return map(std::move(collection), std::function<OutputItem(const typename InputCollection::value_type &)>([](const typename InputCollection::value_type &base) {
