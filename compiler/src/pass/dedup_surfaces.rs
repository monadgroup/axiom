...
fn are_surfaces_equivalent(lhs: &mir::Surface, rhs: &mir::Surface) -> bool {
    // Todo: do groups need to be equal? or is just nodes fine?
    // If groups do, some more work is needed to iron out socket indices generated by the editor,
    // which are somewhat randomly ordered.
