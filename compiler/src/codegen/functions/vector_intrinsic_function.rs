...
define_vector_intrinsic!(SqrtFunction: block::Function::Sqrt => intrinsics::sqrt_v2f64);
define_vector_intrinsic!(CeilFunction: block::Function::Ceil => intrinsics::ceil_v2f64);
define_vector_intrinsic!(FloorFunction: block::Function::Floor => intrinsics::floor_v2f64);
define_vector_intrinsic!(FractFunction: block::Function::Fract => intrinsics::fract_v2f64);
