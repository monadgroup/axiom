...
std::string Token::typeString(Type type) {
    switch (type) {
        ...
        case Type::CAST:
            return "arrow";
        case Type::COMMENT_OPEN:
            return "comment open";
        case Type::COMMENT_CLOSE:
            return "comment close";
        case Type::PLUS_ASSIGN:
            return "add-to operator";
        case Type::MINUS_ASSIGN:
            return "subtract-from operator";
        case Type::TIMES_ASSIGN:
            return "multiply-by operator";
        case Type::DIVIDE_ASSIGN:
            return "divide-by operator";
        case Type::MODULO_ASSIGN:
            return "modulo-by operator";
        case Type::POWER_ASSIGN:
            return "raise-to operator";
        case Type::INCREMENT:
        ...
        case Type::IDENTIFIER:
            return "identifier";
        case Type::UNKNOWN:
            return "...well, I'm not really sure what this is...";
        default:
            return " -- 42 --";
    }
}
