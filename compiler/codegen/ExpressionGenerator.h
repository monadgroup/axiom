...
namespace MaximCodegen {
    ...
    private:
        ...
        void generateSingleAssign(MaximAst::AssignableExpression *leftExpr, Value *rightValue, MaximAst::AssignExpression::Type type, SourcePos rightStart, SourcePos rightEnd, Function *function, Scope *scope);

        void generateBasicAssign(MaximAst::AssignableExpression *leftExpr, Value *rightValue, Function *function, Scope *scope);
        void generateVariableAssign(MaximAst::VariableExpression *leftExpr, Value *rightValue, Function *function, Scope *scope);
        void generateControlAssign(MaximAst::ControlExpression *leftExpr, Value *rightValue, Function *function, Scope *scope);
