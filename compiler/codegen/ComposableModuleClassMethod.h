...
namespace MaximCodegen {
    ...
    public:
        ComposableModuleClassMethod(ComposableModuleClass *moduleClass, std::string name,
                                    llvm::Type *returnType = nullptr, std::vector<llvm::Type *> paramTypes = {});
        ...
        llvm::Value *
        callInto(size_t index, const std::vector<llvm::Value *> &args, const ModuleClassMethod *internalMethod,
