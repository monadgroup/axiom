#include "InternalBiquadFilterFunction.h"
...
InternalBiquadFilterFunction::InternalBiquadFilterFunction(MaximCodegen::MaximContext *ctx, llvm::Module *module)
...
std::unique_ptr<InternalBiquadFilterFunction> InternalBiquadFilterFunction::create(MaximCodegen::MaximContext *ctx,
                                                                   llvm::Module *module) {
    return std::make_unique<InternalBiquadFilterFunction>(ctx, module);
}

std::unique_ptr<Value> InternalBiquadFilterFunction::generate(MaximCodegen::ComposableModuleClassMethod *method,
