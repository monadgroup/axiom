...
namespace MaximAst {
    ...
    public:
        ...
        void appendString(std::stringstream &s) override {
            s << "(control " << name << " ";
            switch (type) {
                case Type::LABEL: s << "label"; break;
                case Type::VALUE: s << "value"; break;
                case Type::TOGGLE: s << "toggle"; break;
                case Type::GRAPH: s << "graph"; break;
                case Type::SCOPE: s << "scope"; break;
                case Type::KEYS: s << "keys"; break;
                case Type::ROLL: s << "roll"; break;
                case Type::PLUG: s << "plug"; break;
            }
            s << " " << prop << ")";
        }
    };
