    ...
    public:
        ...
        void appendString(std::stringstream &s) override {
            ...
            switch (type) {
                ...
                case Type::BITWISE_AND: s << "&"; break;
                case Type::BITWISE_OR: s << "|"; break;
                case Type::BITWISE_XOR: s << "^^"; break;
                case Type::LOGICAL_AND: s << "&&"; break;
                case Type::LOGICAL_OR: s << "||"; break;
                case Type::LOGICAL_EQUAL: s << "=="; break;
                case Type::LOGICAL_NOT_EQUAL: s << "!="; break;
                case Type::LOGICAL_GT: s << ">"; break;
                case Type::LOGICAL_LT: s << "<"; break;
                case Type::LOGICAL_GTE: s << ">="; break;
                case Type::LOGICAL_LTE: s << "<="; break;
            }
            s << " ";
            left->appendString(s);
            s << " ";
