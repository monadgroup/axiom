...
namespace ads {
    ...
    void FloatingDockContainerPrivate::updateDropOverlays(const QPoint &GlobalPos) {
        ...
        if (DockArea && DockArea->isVisible() && VisibleDockAreas > 0) {
            ...
            DockAreaOverlay->setAllowedAreas((VisibleDockAreas == 1) ? NoDockWidgetArea : AllDockAreas);
    ...
    CFloatingDockContainer::CFloatingDockContainer(CDockManager *DockManager)
        : QWidget(DockManager, Qt::Window), d(new FloatingDockContainerPrivate(this)) {
    ...
    //============================================================================
    CDockContainerWidget *CFloatingDockContainer::dockContainer() const { return d->DockContainer; }
