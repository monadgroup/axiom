...
namespace ads {
    ...
    struct DockWidgetTitleBarPrivate {
         ...
         */
        bool isDraggingState(eDragState dragState) { return this->DragState == dragState; }
    ...
    //============================================================================
    DockWidgetTitleBarPrivate::DockWidgetTitleBarPrivate(CDockWidgetTitleBar *_public) : _this(_public) {}
    ...
    bool DockWidgetTitleBarPrivate::startFloating() {
        ...
        if (DockWidget->dockContainer()->isFloating() && (DockWidget->dockContainer()->visibleDockAreaCount() == 1) &&
    ...
    CDockWidgetTitleBar::CDockWidgetTitleBar(CDockWidget *DockWidget, QWidget *parent)
        : QFrame(parent), d(new DockWidgetTitleBarPrivate(this)) {
    ...
    //============================================================================
    CDockWidgetTitleBar::~CDockWidgetTitleBar() { delete d; }
    ...
    void CDockWidgetTitleBar::mouseMoveEvent(QMouseEvent *ev) {
        ...
        if (!MouseInsideTitleArea) {
            ...
            return;
                   ...
                   (ev->pos() - d->DragStartMousePosition).manhattanLength() >=
    ...
    //============================================================================
    bool CDockWidgetTitleBar::isActiveTab() const { return d->IsActiveTab; }
    ...
    //============================================================================
    CDockWidget *CDockWidgetTitleBar::dockWidget() const { return d->DockWidget; }

    //============================================================================
    void CDockWidgetTitleBar::setDockAreaWidget(CDockAreaWidget *DockArea) { d->DockArea = DockArea; }

    //============================================================================
    CDockAreaWidget *CDockWidgetTitleBar::dockAreaWidget() const { return d->DockArea; }
    ...
    //============================================================================
    const QIcon &CDockWidgetTitleBar::icon() const { return d->Icon; }
} // namespace ads
