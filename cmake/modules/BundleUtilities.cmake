...
function(get_dotapp_dir exe bundle_extension dotapp_dir_var)
  set(s "${exe}")

  if(s MATCHES "/.*\\.${bundle_extension}/")
    ...
    while(NOT ${done})
      ...
      set(s "${sdir}")
      if(sname MATCHES "\\.${bundle_extension}")
        set(done 1)
...
function(get_item_key item key_var)
  ...
  string(REPLACE "../../../../Downloads" "_" ${key_var} "${item_name}")
...
function(fixup_bundle_item resolved_embedded_item exepath dirs bundle_extension)
...
function(fixup_bundle app bundle_extension libs dirs)
  message(STATUS "fixup_bundle")
  message(STATUS "  app='${app}'")
  message(STATUS "  bundle_extension='${bundle_extension}'")
    ...
    foreach(key ${keys})
      ...
      if(APPLE)
        ...
        if(NOT "${${key}_COPYFLAG}" STREQUAL "2")
          fixup_bundle_item("${${key}_RESOLVED_EMBEDDED_ITEM}" "${exepath}" "${dirs}" "${bundle_extension}")
        endif()
      else()
...
function(copy_and_fixup_bundle src dst bundle_extension libs dirs)
